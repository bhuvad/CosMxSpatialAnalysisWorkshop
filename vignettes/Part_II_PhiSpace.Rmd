...
multiClustRes <- kmeans(mat2clust, centers = 10, iter.max = 1000L, nstart = 20, algorithm = "Lloyd")
...
multiSampClustCols <- c(
  "1" = "gray50", "2" = "#FF7F00", "3" =  "#FFFF99", "4" = "#1F78B4" , 
  "5" = "black", "6" = "#33A02C", "7" = "#A6CEE3", "8" = "#6A3D9A", "9" = "#B15928", "10" = "#E41A1C", "11" = "#B2DF8A", "12" = "#FB9A99"
)
lapply(1:length(allTissues), function(ii){
  p <- VizSpatial(
