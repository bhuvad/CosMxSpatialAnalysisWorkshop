...
# usethis::use_data(Lung5Rep1GEX, overwrite = T)
# data("Lung5Rep1GEX")
# Banksy parameters
lambda = 0.2
npcs = 50
...
set.seed(94863)
Lung5Rep1_PhiClusts <- kmeans(mat2clust, centers = 8, iter.max = 500L, nstart = 20, algorithm = "Lloyd") 
...
Lung5Rep1_PhiSmoothClusts <- kmeans(mat2clust, centers = 8, iter.max = 500L, nstart = 20, algorithm = "Lloyd")
...
multiSampClustCols <- c(
  "1" = "#FFFF99", "2" = "#FF7F00", "3" = "#6A3D9A" , "4" = "#1F78B4" , 
  "5" = "black", "6" = "#33A02C", "7" = "#A6CEE3", "8" = "gray50", "9" = "#B15928", "10" = "#E41A1C", "11" = "#B2DF8A", "12" = "#FB9A99"
)
lapply(1:length(allTissues), function(ii){
  p <- VizSpatial(
...
```{r}
XX <- lapply(1:length(allTissues), function(x) reducedDim(allTissues[[x]], "PhiSpace")) 
XX <- do.call(rbind, XX)
